...
public class StockAnalyze extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spec = tabHost.newTabSpec("Stock List").setIndicator("Stock List").setContent(intent);
		
		tabHost.addTab(spec);

		intent = new Intent().setClass(this, StockSearchActivity.class);
		spec = tabHost.newTabSpec("Stock search").setIndicator("Stock Search").setContent(intent);
		tabHost.addTab(spec);
